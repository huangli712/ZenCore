...
const PDFT   = Dict{String,ADT}(
    ...
    "lsymm"    => [missing, 1, :Bool  , "Is the symmetry turned on or off"],
    "lspins"   => [missing, 1, :Bool  , "Are the spin orientations polarized or not"],
    "lspinorb" => [missing, 1, :Bool  , "Is the spin-orbit coupling considered or not"],
    "lproj"    => [missing, 1, :Bool  , "Are the projectors generated or not"],
